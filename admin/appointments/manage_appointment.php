...
<div class="container-fluid">
    ...
    <div class="row" id="appointment">
        <div class="col-6" id="frm-field">
            ...
            <input type="hidden" name="patient_id" value="<?php echo isset($patient_id) ? $patient_id : '' ?>">
                <div class="form-group">
                    <label for="name" class="control-label">Nombre Completo del Dueño</label>
        ...
        <div class="col-6">
                <div class="form-group">
                    <label for="dob" class="control-label">Fecha de Nacimiento de la Mascota</label>
