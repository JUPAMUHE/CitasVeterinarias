...
<div class="container-fluid">
    <p><b>Fecha y hora de la Cita:</b> <?php echo $date_sched;?></p>
    <p><b>Nombre del Dueño:</b> <?php echo $patient['name'] ?></p>
    ...
    <p><b>Nombre de la Mascota:</b> <?php echo $ailment ?></p>
    <p><b>Género de la Mascota:</b> <?php echo ucwords($patient['gender']) ?></p>
    <p><b>Estado:</b>
        <?php 
        switch($status){ 
            case(0): 
